...
from ofa.imagenet_classification.data_providers import ImagenetDataProvider,Cifar100DataProvider

__all__ = ["RunConfig", "DistributedCifar100RunConfig","Cifar100RunConfig","ImagenetRunConfig", "DistributedImageNetRunConfig"]
...
class Cifar100RunConfig(RunConfig):
    ...
    def data_provider(self):
        if self.__dict__.get("_data_provider", None) is None:
            if self.dataset == Cifar100DataProvider.name():
...
class DistributedCifar100RunConfig(Cifar100RunConfig):
    def __init__(
        self,
        n_epochs=150,
        init_lr=0.05,
        ...
        **kwargs
        ...
        super(DistributedCifar100RunConfig, self).__init__(
            n_epochs,
            init_lr,
            lr_schedule_type,
            lr_schedule_param,
